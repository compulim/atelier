...
function SourceCode(props: Props) {
  ...
  return (
    <div className="atelier__source-code">
      {htmlCode ? (
        <div
          className="atelier__source-code__code atelier__source-code__code--shiki"
          dangerouslySetInnerHTML={htmlCode}
        />
      ) : (
        <pre className="atelier__source-code__code atelier__source-code__code--plain">{prettifiedCode}</pre>
      )}
    </div>
  );
}
